...
"""User login function.
Check to see if user exists by email. If User doesnt exist then create new user entry and
return unique user ID, if user is found return existing user ID. Store user ID in login_session variable.
"""
...
def subCat(id):
    ...
    return render_template('subcat.html', side_nav=side_nav, subs=subs, newtitle=new_title)


# Selected movie summary: including title, description, posted user and links to edit.
...
def itemDetails(id):
    ...
    user_post = session.query(Users).filter_by(user_id=subs.userpost_id).first()
    return render_template('items.html', side_nav=side_nav, subs=subs, user_post=user_post)
...
def itemEdit(id):
    ...
    if request.method == 'POST':
        ...
        return render_template('itemedit.html', side_nav=side_nav, item=itemValue)
...
def delItem(id):
    ...
    if request.method == 'GET':
        ...
        return render_template('itemedit.html', side_nav=side_nav, item=itemToDelete)
